...
class OrbitPolyfitIterpolator:
    ...
    epoch: np.datetime64
    interval: T.Tuple[np.datetime64, np.datetime64]
    ...
    def from_position(
        ...
        interval: T.Optional[T.Tuple[np.datetime64, np.datetime64]] = None,
    ...
    def position(
        self, time: T.Optional[xr.DataArray] = None, **kwargs: T.Any
    ) -> xr.DataArray:
        if time is None:
